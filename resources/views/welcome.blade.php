...
@section('content')
    ...
    <main>
        <div id="jssor_1"
             style="position:relative;margin:0 auto;top:0px;left:0px;width:1300px;height:250px;overflow:hidden;visibility:hidden;box-shadow: 0px 5px 5px grey;z-index: 9">
            <!-- Loading Screen -->
            ...
            <div data-u="slides"
                 style="cursor:default;position:relative;top:0px;left:0px;width:1300px;height:250px;overflow:hidden;">
                @foreach($ads as $ad)
                    @if($ad->active)
                        <div>
                            <img data-u="image" src="{{asset($ad->img)}}"/>
                        </div>
                    @endif
                @endforeach
            </div>
            ...
            <!-- Arrow Navigator -->
            <div data-u="arrowleft" class="jssora051" style="width:40px;height:40px;top:0px;left:25px; opacity: 0.75" data-autocenter="2"
                 data-scale="0.75" data-scale-left="0.75">
                <i class="fa fa-chevron-left" style="margin-left:13px;margin-top: 13px;"></i>
            </div>
            <div data-u="arrowright" class="jssora051" style="width:40px;height:40px;top:0px;right:25px; opacity: 0.75"
                 data-autocenter="2" data-scale="0.75" data-scale-right="0.75">
                <i class="fa fa-chevron-right" style="margin-left:15px;margin-top: 13px;"></i>
            </div>
        </div>
        <!-- End Slider Part -->
        <!-- Start Welcome Part -->

        <section id="reach-to" class="welcome-part home-icon mMenu">
            <div class="trans_icons_cont">
                <img class="icoF" src="{{asset('images/fish_icon.png')}}">
                <img class="icoB" src="{{asset('images/banana_icon.png')}}">
                <img class="icoC" src="{{asset('images/carrot_icon.png')}}">
            </div>
            <div class="container mPadding">
                <div class="build-title"> <h2>АТМfood - ваш вкусный сервис </h2> </div>

                <div id="crab" class="col-md-2 col-sm-4 col-xs-4"><a href="{{route('restaurant.list')}}"> <img id="big_crab" src="{{asset('images/category/restaurants.png')}}" alt=""><h5 id="main">Все рестораны</h5></a></div>
                @foreach($specefications as $specefication)
                    <div class="col-md-2 col-sm-4 col-xs-4"><a href="{{route('restaurant.specefication',['specefication' => $specefication->id])}}"><img id="pizza" src="{{asset($specefication->img)}}" alt=""><h5 id="pizza_h" style="">{{$specefication->name}}</h5></a></div>
                @endforeach
                {{--<div class="col-md-2 col-sm-4 col-xs-4"><a href="#"><img id="sushi" src="{{asset('images/category/sushi.png')}}" alt=""><h5 id="sushi_h" style="">Суши</h5></a></div>--}}
                {{--<div id="div-barbecue" class="col-md-2 col-sm-4 col-xs-4"><a href="#"><img id="barbecue" src="{{asset('images/category/barbecue.png')}}" alt=""><h5 id="barbecue_h" style="">Шашлыки</h5></a></div>--}}
                {{--<div id="div-fastfood" class="col-md-2 col-sm-4 col-xs-4"><a href="#"><img id="fastfood" src="{{asset('images/category/fastfood.png')}}" alt=""><h5 id="fastfood_h" style="">Фастфуд</h5></a></div>--}}
                {{--<div id="div-dessert" class="col-md-2 col-sm-4 col-xs-4"><a href="#"><img id="dessert" src="{{asset('images/category/dessert.png')}}" alt=""><h5 id="dessert_h" style="">Десерт</h5></a></div>--}}
            </div>
            <div class="trans_icons_cont">
                <img class="icoBr" src="{{asset('images/bread_icon.png')}}">
                <img class="icoA" src="{{asset('images/apple_icon.png')}}">
                <img class="icoCh" src="{{asset('images/chicken_icon.png')}}">
            </div>
        </section>
        <section id="reach-to" class="welcome-part home-icon applications" style="background: url({{asset('images/main/main_fish.jpg')}}); background-position: center; background-repeat: no-repeat; background-size: cover">
            <div id="atm_food_with" class="container">
                <div class="col-md-7"><img id="devices" src="{{asset('images/main/devices.png')}}" alt=""></div>

                <div id="info-devices" class="col-md-5">
                    <h2>ATMfood</h2>
                    <h4>всегда с тобой</h4>
                    <a href="#"><img id="app_store_img" src="{{asset('images/category/appstore.png')}}" width="200" height="50" alt=""></a>
                    <a href="#"><img id="gp_img" src="{{asset('images/category/gp.png')}}" width="200" height="50" alt=""></a>
                </div>
            </div>
        </section>
        <section id="reach-to" class="welcome-part home-icon">
            <div class="container mPadding">
                <div class="build-title">
                    <h2>Лучшие предложения и скидки</h2>
                </div>
                <div class="col-md-6" id="discount">
                    <img id="discount_img" class="img-rounded" src="{{asset('images/category/skidka_1.jpg')}}" width="500"
                         height="266" alt="">
                    <div id="offer">
                        <div id="transparent_div" class="discount_1">
                            <h3>Скидки на итальянское меню 15%</h3>
                            <a href="#" id="restaurant">от Soltan Restoran</a>
                            <a href="#">
                                <button id="more_button">Подробнее</button>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6" id="discount">
                    <img id="discount_img" class="img-rounded" src="{{asset('images/category/skidka_2.jpg')}}" width="500"
                         height="266" alt="">
                    <div id="offer">
                        <div id="transparent_div" class="discount_2">
                            <h3>Скидки на бургеры и донер 20%</h3>
                            <a href="#" id="restaurant">от Altyn Ada</a>
                            <a href="#">
                                <button id="more_button">Подробнее</button>
                            </a>
                        </div>
                ...
                <div class="col-md-6" id="discount">
                    <img id="discount_img" class="img-rounded " src="{{asset('images/category/skidka_3.jpg')}}" width="500"
                         height="266" alt="">
                    <div id="offer">
                        <div id="transparent_div" class="discount_3">
                            <h3>Скидки на все салаты 25%</h3>
                            <a href="#" id="restaurant">от Ashgabat Restoran</a>
                            <a href="#">
                                <button id="more_button">Подробнее</button>
                            </a>
                        </div>
                ...
                <div class="col-md-6" id="discount">
                    <img id="discount_img" class="img-rounded " src="{{asset('images/category/skidka_4.jpg')}}" width="500"
                         height="266" alt="">
                    <div id="offer">
                        <div id="transparent_div" class="discount_4">
                            <h3>Скидки на фруктовый fresh 15%</h3>
                            <a href="#" id="restaurant">от Rahat Coffee</a>
                            <a href="#">
                                <button id="more_button">Подробнее</button>
                            </a>
                        </div>
                ...
                <div>
                    <a href="#" class="grBtn">Посмотреть все предложения</a>
                </div>
            </div>
            <!--<div class="float-main">
                <div class="icon-top-left"><img src="../../images/icon1.png" alt=""></div>
                <div class="icon-bottom-left"><img src="../../images/icon2.png" alt=""></div>
                <div class="icon-top-right"><img src="../../images/icon3.png" alt=""></div>
                <div class="icon-bottom-right"><img src="../../images/icon4.png" alt=""></div>
            </div>-->
        </section>
    </main>
@endsection