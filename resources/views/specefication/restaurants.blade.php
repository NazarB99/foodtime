            ...
            <section class="breadcrumb-part"
                ...
                <div class="container">
                    <div class="breadcrumb-inner">
                        ...
                        <span>Список всех ресторанов</span>
                    </div>
                </div>
            </section>
            <div class="grk1">
                        ...
                        <div class="galleryportfolio">
                            <div class="portfolioFilter-inner bg-skeen">
                                ...
                                @foreach($restaurant_categories as $restaurant_category)
                                    <a href="javascript:;" data-filter=".{{$restaurant_category->id}}" style="font-family: Ubuntu">{{$restaurant_category->name}}</a>
                                @endforeach
                            </div>
                        </div>
                        <div class="row gallery-filter">
                            @foreach($spec->restaurants as $restaurant)
